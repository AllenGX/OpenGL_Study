...
glm::vec3 lightPos(0.0f, 0.25f, 1.0f);
...
int main()
{
	...
	// ------------------------------------
	Shader lightingShader("Multiple-lights/Multiple-lights.vs", "Multiple-lights/Multiple-lights-partice-2/Multiple-lights-partice-2.fs"); // you can name your shader files however you like
	Shader lampShader("Light-color/Light-color.vs", "Light-color/Light.fs");
	...
	// textrue1
	// --------------------
	unsigned int diffuseMap = loadTexture("resource/textures/container2.png");
	...
	// textrue2
	// --------------------
	unsigned int diffuseMap_specular = loadTexture("resource/textures/container2_specular.png");
	...
	//glBindTexture(GL_TEXTURE_2D, diffuseMap_specular);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glClearColor(0.78f, 0.79f, 0.8f, 1.0f);
		...
		lightingShader.setVec3("light.diffuse", 0.0f, 1.0f, 0.0f);
		lightingShader.setVec3("light.specular", 0.0f, 1.0f, 0.0f);
		lightingShader.setFloat("light.constant", 1.0f);
		lightingShader.setFloat("light.linear", 0.07);
		lightingShader.setFloat("light.quadratic", 0.017);
