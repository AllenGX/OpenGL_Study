...
int main()
{
	...
	// -------------------------
	Shader shader("Face-culling/Face-culling.vs", "Face-culling/Face-culling.fs");
	...
	unsigned int grassTexture = loadTexture("resource/textures/window.png");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glCullFace(GL_FRONT);	//只剔除正面（默认为逆时针）
		glBindVertexArray(cubeVAO);
